function Validimi() {
  ...
  if(a == ""|| a.match(/[A-Za-z]/)|| a.match(/[A-Za-z]+[0-9]/)){
    Mesazhi2.innerHTML = "Keni shenuar emrin gabim";
  }
...
//==========================================================================================
  ...
  if(b == ""|| b.match(/[A-Za-z]/)|| b.match(/[A-Za-z]+[0-9]/)){
    Mesazhi3.innerHTML = "Keni shenuar emrin gabim";
  }
  ...
  if(f == ""|| f.match(/[A-Za-z]/)|| f.match(/[A-Za-z]+[0-9]/)){
    Mesazhi7.innerHTML = "Keni shenuar emrin gabim";
  }
  ...
  if(g == ""|| g.match(/[A-Za-z]/)|| g.match(/[A-Za-z]+[0-9]/)){
    Mesazhi8.innerHTML = "Keni shenuar emrin gabim";
  }
  else if(b.length>15){
  ...
  if(h == ""|| h.match(/[A-Za-z]/)|| h.match(/[A-Za-z]+[0-9]/)){
    Mesazhi9.innerHTML = "Keni shenuar emrin gabim";
  }
